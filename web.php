...
Route::middleware("admin")->group(function(){
    Route::get("/admin", [EbookController::class, "admim"] )->name("admin.dashboard");
});
...
Route::put('/books/{book}', [Books::class, 'update'])->name('books.custom_update');
...
Route::get('/book_history', [BookHistoryController::class, 'index'])->name('book_history.index');
Route::get('/book_history/create', [BookHistoryController::class, 'create'])->name('book_history.create');
Route::post('/book_history', [BookHistoryController::class, 'store'])->name('book_history.store');